                ...
                <div class="card-body rounded-0 text-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group icon-input mb-3">
                            ...
                            <input id="email" type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="Địa chỉ email của bạn">
                            @error('email')
