            ...
            <div class="row">
                <div class="col-lg-5 offset-lg-1 mb-4">
                    <div class="product-slider-3 owl-carousel owl-theme dot-none owl-nav-link edge-link">
                        <div class="owl-items pt-lg--10 pb-lg--10 bg-white rounded-3"><img
                                data-thumb="<img src='../images/pl7.png' />" src="../images/pl7.png" alt="icon"></div>
                        <div class="owl-items pt-lg--10 pb-lg--10 bg-white rounded-3"><img
                                data-thumb="<img src='../images/pl8.png' />" src="../images/pl8.png" alt="icon"></div>
                        <div class="owl-items pt-lg--10 pb-lg--10 bg-white rounded-3"><img
                                data-thumb="<img src='../images/pl9.png' />" src="../images/pl9.png" alt="icon"></div>
                        <div class="owl-items pt-lg--10 pb-lg--10 bg-white rounded-3"><img
                                data-thumb="<img src='../images/pl6.png' />" src="../images/pl6.png" alt="icon"></div>
                    </div>
                    <div class="d-flex">
