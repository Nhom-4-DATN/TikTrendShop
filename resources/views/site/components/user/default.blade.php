                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="list-inline mb-4">
                            ...
                            <li class="list-inline-item d-block border-bottom me-0"><a href="#"
                                    class="pt-2 pb-2 d-flex align-items-center"><i
                                        class="btn-round-md bg-gold-gradiant text-white feather-map-pin font-md me-3"></i>
                                    <h4 class="fw-600 font-xsss mb-0 mt-0">Địa chỉ của bạn</h4><i
                                        class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                                </a></li>
                            <li class="list-inline-item d-block border-bottom me-0"><a href="{{ route('register.shop') }}"
                                    class="pt-2 pb-2 d-flex align-items-center"><i
                                        class="btn-round-md bg-gold-gradiant text-white feather-shopping-cart font-md me-3"></i>
                                    <h4 class="fw-600 font-xsss mb-0 mt-0">Đăng ký cửa hàng miễn phí</h4><i
                                        class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                                </a></li>
                        </ul>
                        ...
                        <ul class="list-inline mb-4">
                            <li class="list-inline-item d-block border-bottom me-0"><a href="payment.html"
                                    ...
                                    <h4 class="fw-600 font-xsss mb-0 mt-0">Thẻ ngân hàng</h4><i
                                        class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                                </a></li>
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item d-block border-bottom me-0"><a href="default-notification.html"
                                    ...
                                    <h4 class="fw-600 font-xsss mb-0 mt-0">Thông báo</h4><i
                                        class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                                </a></li>
                            <li class="list-inline-item d-block border-bottom me-0"><a href="help-box.html"
                                    ...
                                    <h4 class="fw-600 font-xsss mb-0 mt-0">Hỗ trợ</h4><i
                                        class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i>
                                </a></li>
