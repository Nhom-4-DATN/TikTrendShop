            ...
            <div class="row">
                <div class="col-lg-12">
                    <div
                        ...
                        <h2 class="display2-size display2-md-size fw-700 text-white mb-0 mt-0">Products
                ...
                <div class="col-lg-12 mt-3">
                    <h4 class="float-left font-xssss fw-700 text-grey-500 text-uppercase ls-3 mt-2 pt-1">Top products
                    </h4>
