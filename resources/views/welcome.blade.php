...
<body>
    <section class="home">
        ...
        <div class="users-color-container">
            ...
            <img class="item" {{-- src="https://github.com/ecemgo/mini-samples-great-tricks/assets/13468728/274f29ce-0d3f-4ac2-a2aa-f9b7bd188b2a" --}} src="{{ asset('images/jinchill.jpg') }}" style="--i: 2"
                alt="" />
